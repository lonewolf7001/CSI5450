  ...
  <div>
    ...
    <div class="container2">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          <tr v-for="(home, index3) in homes_b" v-bind:key="home.homeId">
            <td>{{ home.homeId }}</td>
...
export default {
  ...
  methods: {
      getHomesbysamebrandResponse(){
          HomeService.getHomesbysamebrand().then((response) => {
