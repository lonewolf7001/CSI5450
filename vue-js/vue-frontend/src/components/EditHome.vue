<template>
    <div>
        ...
        <div class= "container2">
            <div class= "row3">
            <div class="col-sm-4"><Button class="btn1" text="Select a city" color="lightblue" disabled></Button></div>
            <div class="col-sm-4">
        ...
        <div class= "container2">
            ...
            <div class= "row3"> 
                ...
                <div class= "col2"> <input v-model="home_price" placeholder="" disabled/></div>
            </div>
            ...
            <div class="row3">
            <div class="col1"></div>
            <div class="col2"><Button class="btn1" text="Update Home" color="lightgreen" v-on:click= this.UpdateHome() ></Button></div>
            </div>
        </div>
    </div>
</template>
...
import OwnerService from '@/services/OwnerService'
    ...
    methods: {
        selectedHome() {
            this.updateHome = this.homes.find(homes => homes.homeId === this.selected_homeId)
        ...
        UpdateHome(){
                HomeService.update(this.updateHome.homeId, this.updateHome).then(response => {
